...
int maxSpeed = 130;//180  //180 //200
int  sSpeed = 80;
#define linegapSpeed 120

int ftrigger = 12, fecho = 2;
...
distance = trigger(ftrigger, fecho);
...
long mstocm(unsigned long microseconds)
{
...
int trigger(int trigPin,int echoPin)
{
  ...
  while(1)
  {
    ...
    else if(micros()-oldTime>=timeLimit)
    {
      time=timeLimit;
      break;  
    }  
